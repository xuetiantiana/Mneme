...
export const GetPCMList = (): any => {
  return request.get("/api/pcm/list");
};

export const GetPCMGallery = (): any => {
  return request.get("/api/pcm/gallery").then((response: any) => {
...
export const GetStoryList = (): any => {
  return request.get("/api/story/list");
};
        ...
        groups: [
          {
            ...
            concept: "",
            placement: "left",
            segment_refs: ["PCM-20260314055223235-372f15e117-segment-1"],
          },
          {
            ...
            concept: "",
            placement: "right",
            segment_refs: ["PCM-20260314055223235-372f15e117-segment-2"],
          },
        ],
        connections: [
          {
...
export const ReflectHint = (data: any): any => {
  ...
  const response = {
    success: true,
    data: {
      depths: ["描述层", "感受层", "评价层", "分析层", "结论层", "行动层"],
      perspectives: [
        {
          id: "perspective-YYYY***-***",
          name: "Quiet Shape",
...
export const ReflectQuestions = (data: any): any => {
  ...
  const response = {
    success: true,
    data:
      ReflectQuestionsNum === 1
        ? data1
        : ReflectQuestionsNum === 2
          ? data2
          : data3,
  };
...
export const ConstellateHint = (data: any): any => {
  ...
  const data2 = {
    ...
    perspectives: [
      ...
      {
        id: "Excess and Imbalance",
        name: "Excess and Imbalance",
      },
      {
        id: "frustration",
        name: "Frustration",
  ...
  const response = {
    success: true,
    data: ConstellateHintNum === 1 ? data1 : data2,
  };
...
export const ConstellateSuggest = (_data: any): any => {
  ...
  const data1 = {
    title:
      "What cannot be restored may still be revered. \nWhat do you still keep, even broken?",
    images: [
      {
        ...
        pcm_ref: "PCM-26",
        reason:
          "A rough saw becomes music, turning damage into a new kind of value.",
      },
      {
        ...
        pcm_ref: "PCM-24",
        reason:
          "A children's book kept for its imperfect truth about an adult self.",
      },
      {
        ...
        pcm_ref: "PCM-46",
        reason:
          "A rustic ceramic piece feels worth keeping even when its use is incomplete.",
      },
    ],
  };
  const data2 = {
    title:
      "A missing part can open a larger horizon. \nWhat did loss allow you to see?",
    images: [
      {
        ...
        pcm_ref: "PCM-31",
        reason:
          "The sea view opened a wider future and a new way of seeing life.",
      },
      {
        ...
        pcm_ref: "PCM-48",
        reason:
          "A sculpture carries quiet force, as if absence makes its presence stronger.",
      },
      {
        ...
        pcm_ref: "PCM-58",
        reason:
          "Venus de Milo shows how a missing part can deepen awe instead of reduce it.",
      },
    ],
  };
  ...
  const data3 = {
    title:
      "Beauty begins where precision loosens. \nWhen did imperfection feel more alive?",
    images: [
      {
        ...
        pcm_ref: "PCM-12",
        reason:
          "The wool version is not exact, but its awkwardness gives it charm.",
      },
      {
        ...
        pcm_ref: "PCM-35",
        reason:
          "The handmade cat bag feels vivid because its shape is strange and slightly off.",
      },
      {
        ...
        pcm_ref: "PCM-41",
        reason:
          "These odd dolls feel more alive because their details are weirdly imperfect.",
      },
    ],
  };
  ...
  const data4 = {
    title:
      "Soft Covering — Would this healing feel more like a gentle covering than a hard repair?",
    images: [
      {
        image_id: "img-upload-pcm12",
        image_url: "/image_for_video/constellate4_1.png",
        pcm_ref: "PCM-12",
        reason: "The wall is not restored; it is slowly re-skinned.",
      },
      {
        image_id: "img-upload-pcm35",
        image_url: "/image_for_video/constellate4_2.png",
        pcm_ref: "PCM-35",
        reason: "Snow lets their exposed fragility rest under a softer layer",
      },
      {
        image_id: "img-upload-pcm41",
        image_url: "/image_for_video/constellate4_3.png",
        pcm_ref: "PCM-41",
        reason: "The wall is not restored; it is slowly re-skinned.",
      },
    ],
  ...
  const data5 = {
    title:
      "Bound before healing \nCan you recall any moments when something was merely tied up instead of being fixed?",
    images: [
      {
        image_id: "img-upload-pcm12",
        image_url: "/image_for_video/constellate5_1.png",
        pcm_ref: "PCM-12",
        reason: "A fragile mess held together after damage",
      },
      {
        image_id: "img-upload-pcm35",
        image_url: "/image_for_video/constellate5_2.png",
        pcm_ref: "PCM-35",
        reason: "Trying to place oneself back into a broken timeline",
      },
      {
        image_id: "img-upload-pcm41",
        image_url: "/image_for_video/constellate5_3.png",
        pcm_ref: "PCM-41",
        reason: "Bound and supported rather than fully healed.",
      },
    ],
  };
  const response = {
    success: true,
    data:
      ConstellateSuggestNum === 1
        ? data1
        : ConstellateSuggestNum === 2
          ? data2
          : ConstellateSuggestNum === 3
            ? data3
            : ConstellateSuggestNum === 4
              ? data4
              : data5,
  };
...
export const ResonanceHint = (data: any): any => {
  ...
  const response = {
    success: true,
    data:
      ResonanceHintNum === 1 ? data1 : ResonanceHintNum === 2 ? data2 : data3,
  };
...
export const ResonanceAnalysis = (_data: any): any => {
        ...
        actions: [
          {
            kind: "whisper",
            description:
              "Write one line about a life beginning after usefulness.",
          },
          {
            kind: "crop",
            description:
              "Crop the detail that feels closest to a mouth or voice.",
          },
          {
            kind: "add_memory",
      ...
      },
      {
        ...
        actions: [
          ...
          },
          {
            kind: "add_memory",
            description:
              "Add a memory of being drawn to something visibly imperfect.",
          },
        ],
      },
      {
        ...
        actions: [
          {
            kind: "whisper",
            description:
              "Write a line about identity arriving after duty ends.",
          },
          {
            kind: "crop",
            description:
              "Crop the detail that feels most like a scar or emblem.",
          },
          {
            kind: "add_memory",
            description:
              "Add a memory of someone or something changed by no longer being needed.",
          },
        ],
      },
    ],
    ...
    analysis: [
      {
        ...
        level: 4,
        keyword: "Soft Repair",
        text: "This group suggests repair shifting from mechanical fixing to organic covering; try a direction where damage is carried forward by gentle growth rather than restored by force. ",
        confidence: 0.9,
        actions: [
          {
            kind: "whisper",
            description:
              "Refine the group meaning as: repair continues when control gives way to care. ",
          },
          {
            kind: "crop",
            description:
              "Crop the robot hand and the densest vine edge to show the handoff from tool to growth. ",
          },
          {
            kind: "add_memory",
            description:
              "Add a memory of something that recovered only after you stopped forcing it. ",
          },
        ],
      },
      {
        kind: "contrast",
        level: 4,
        keyword: "Gentle Claim",
        text: "The interpretations point to a reversal of repair logic: hard intervention exposes the break, while soft takeover makes a new surface; try who or what becomes the real caretaker. ",
        confidence: 0.82,
        actions: [
          {
            kind: "whisper",
            description:
              "Write: the wound stayed, but something softer learned how to hold it. ",
          },
          {
            kind: "crop",
            description:
              "Crop the metal joints, tools, and the vine-covered window frame to sharpen the hard-versus-soft contrast. ",
          },
          {
            kind: "add_memory",
            description:
              "Add a memory about replacing correction with patience, wrapping, or slow attachment. ",
          },
        ],
      },
      {
        ...
        level: 4,
        keyword: "New Surface",
        text: "This group feels less about fixing a body than letting another life form finish the repair",
        confidence: 0.74,
        actions: [
          {
            kind: "whisper",
            description:
              "Focus the meaning as: it was not repaired back, it was grown onward. ",
          },
          {
            kind: "crop",
            description:
              "Crop rust, seams, and leaf-covered edges that read like a second skin forming. ",
          },
          {
            kind: "add_memory",
            description:
              "Add a memory of wrapping, scabbing, overgrowing, or an old object being softly reclaimed. ",
          },
        ],
      },
    ],
    ...
    analysis: [
      {
        ...
        level: 2,
        keyword: "sacred",
        text: "The group shifts from failed self-repair to public reverence, linking the interpretations \u201crepair is not always restoration\u201d and \u201cwhat no longer cuts may still learn to sing.\u201d The museum memory turns the robot from a private survivor into a figure people gather to witness.",
        confidence: 0.9,
        actions: [
          {
            kind: "whisper",
            description: "Write a note about being honored, not repaired.",
          },
          {
            kind: "crop",
            description: "Crop the pedestal, columns, and looking-up crowd.",
          },
          {
            kind: "add_memory",
            description:
              "Add a memory of feeling small inside a grand museum space.",
          },
        ],
      },
      {
        ...
        level: 2,
        keyword: "gesture",
        text: "Both the sculpture hall and the robot story turn a body into something to be watched, not just used. This fits the interpretations \u201cThe saw was not repaired into usefulness; it drifted into music\u201d and \u201cbrokenness can become a new state.\u201d",
        confidence: 0.79,
        actions: [
          {
            kind: "whisper",
            description:
              "Write a note about a broken part becoming a performance.",
          },
          {
            kind: "crop",
            description: "Crop the saw-arm and the strongest statue-like pose.",
          },
          {
            kind: "add_memory",
            description:
              "Add a memory of seeing stillness feel powerful and alive.",
          },
        ],
      },
      {
        ...
        level: 1,
        keyword: "rise",
        text: "The story can read as a clear sequence: failed repair, accidental music, then public recognition. This connects the vine, the saw, the audience, and the museum into one rising arc.",
        actions: [
          {
            kind: "whisper",
            description:
              "Write a note about first making sound, then being heard.",
          },
          {
            kind: "crop",
            description:
              "Crop three beats: vine on blade, teaching others, museum stage.",
          },
          {
            kind: "add_memory",
            description:
              "Add a memory of your first time standing in front of a crowd.",
          },
        ],
      },
    ],
  ...
  const response = {
    success: true,
    data:
      ResonanceAnalysisNum === 1
        ? data1
        : ResonanceAnalysisNum === 2
          ? data2
          : data3,
  };
...
export const ResonanceFuse = (_data: any): any => {
  ...
  const response = {
    ...
    data: {
      ...
      type: "fuse",
      image_url:
        "https://mneme-gcakhrgtedbjerhz.westus2-01.azurewebsites.net/api/images/test_user/pcm/PCM-20260316014203014-9081ad0ba7/generated/img-gen-20260316014229726-25d90aaa7f.png",
      image_prompt:
        "A soft picture-book collage illustration blending temple cats, serene water reflections, and warm golden light into a dreamlike composite scene",
      description:
        "两段记忆中的宁静氛围被融合——寺庙中猫咪的安然与水面雕塑的灵性共存，交织出一个温暖又略带神秘的拼贴画面。",
...
export const ResonanceFuseNew = (_data: any): any => {
  ...
  const data1 = {
    ...
    type: "fuse_new",
    description:
      "When its broken blade can no longer cut, a pruning robot discovers that what once failed as a tool can still sing as something new.",
    ...
    images: [
      {
        ...
        image_prompt:
          "the robot discovers that its saw-arm has cracked and can no longer cut through branches",
      },
      {
        index: 1,
        image_url: "/image_for_video/fuse1_2.png",
        image_prompt:
          "It struggles to fix the damage, but every attempt only deepens its sense of loss and helplessness",
      },
      {
        index: 2,
        image_url: "/image_for_video/fuse1_3.png",
        image_prompt:
          "Then, by chance, it draws sound from the broken blade and finds a new purpose—not in working, but in moving others",
      },
    ],
  ...
  const data2 = {
    ...
    type: "fuse_new",
    description:
      "When a worn robot tries to heal its broken saw-arm with vines, an accidental sound reveals that survival may begin where repair fails.",
    keywords: ["窗台暖光", "旧书走廊", "雨后小院"],
    images: [
      {
        index: 0,
        image_url: "/image_for_video/fuse2_1.png",
        image_prompt: "It stands lost and uncertain",
      },
      {
        index: 1,
        image_url: "/image_for_video/fuse2_2.png",
        image_prompt:
          "It wraps the saw-arm with living vines, testing one more fragile way to hold itself together.",
      },
      {
        index: 2,
        image_url: "/image_for_video/fuse2_3.png",
        image_prompt:
          "The vine brushes the blade and music rises unexpectedly.",
      },
    ],
    created_at: "2026-03-31T10:00:00.000Z",
  };
  const data3 = {
    ...
    type: "fuse_new",
    description:
      "A broken machine sang so softly that, one by one, the forgotten began to listen.",
    keywords: ["窗台暖光", "旧书走廊", "雨后小院"],
    images: [
      {
        index: 0,
        image_url: "/image_for_video/fuse3_1.png",
        image_prompt:
          "On a quiet street, she played as if no one had ever asked her to be whole.",
      },
      {
        index: 1,
        image_url: "/image_for_video/fuse3_2.png",
        image_prompt: "Inside the museum, her broken song became a light.",
      },
      {
        index: 2,
        image_url: "/image_for_video/fuse3_3.png",
        image_prompt:
          "Her song drifted inward, and the lonely came singing after it.",
      },
    ],
    created_at: "2026-03-31T10:00:00.000Z",
  };
  const response = {
    success: true,
    data:
      ResonanceFuseNewNum === 1
        ? data1
        : ResonanceFuseNewNum === 2
          ? data2
          : data3,
  };
      ...
      bubbles: [
        {
          ...
          r: 30,
          specificity:
            ReflectQuestionsNum == 1 ? 5 : ReflectQuestionsNum == 2 ? 3 : 1,
          id: "PCM-20260314055223235-372f15e117-bubble-3",
          type: "bubble",
        },
      ],
...
export const ExportData = (formData: any, config: any = {}): any => {
  ...
  return request.post("/api/export/data", formData, {
    ...config,
    headers,
  });
};
